  ...
  getDataClass() {
    ...
    this.classService.getclassesList().pipe(
      ...
      next: (response) => {
       ...
       /*alert("Estoy en listClasss-component - line 95 - this.DataClass.Class.name="+ this.DataClass[0].classname);
       alert("Estoy en listClasss-component - line 86 - this.DataClass.Class.image="+ this.DataClass[0].image);
